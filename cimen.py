...
# Parameters to set ########################################################################################################
site_name = 'Cimen'
instrument = 'Synthetic data'
###
wdir = '/media/marc/GFZDRIVE/datadrive/projects/medsuv_heiko/synthetic_test/' # Work directory
dat_wl = 'Cimen.csv' # File that holds the water level data 
...
slice_t2 = '2014-05-20 00:00'   # Slicing end time
###
...
ir = "10min"     # Temporal interpolation rate (e.g., 5min, H, D, M)
...
for e in range(len(eid)):
    ...
    # tp is the temporal offset since the last fill event (this equals the drawdown time)

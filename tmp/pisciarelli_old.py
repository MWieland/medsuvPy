...
slice_t2 = '2014-07-01 11:00'   # slicing end time
###
...
func = 'linear' # temporal interpolation function ('linear', 'time', 'index', 'values', 'nearest', 'zero', 'slinear',
                # 'quadratic', 'cubic', 'barycentric', 'krogh', 'polynomial', 'spline', 'piecewise_polynomial', 'pchip')
###
